    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 mb-1">Tambah Dosen Baru</h1>
                    <p class="text-gray-600 text-sm">Lengkapi formulir di bawah untuk menambahkan dosen baru</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <h2 class="text-base font-semibold text-gray-900">Informasi Dosen</h2>
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-blue-700">
                        <ul class="list-disc list-inside space-y-1">
                            <li>NIDN harus unik dan terdiri dari 10 digit angka</li>
                            <li>Pastikan email aktif untuk notifikasi jadwal</li>
                            <li>Gelar akademik bersifat opsional dan dapat ditambahkan nanti</li>
                        </ul>
                    </div>
                </div>
            </div>
